...
public interface IStockItemMapper {
    ...
    StockItemEntity toEntity(StockItemRequest request);
    ...
    StockItemResponse toResponse(StockItemEntity stockItem);
     ...
     */
    List<StockItemResponse> toResponseList(List<StockItemEntity> stockItems);
    ...
    @Mapping(target = "usages", ignore = true)
    StockItemEntity toEntity(StockItemFileData stockFileData);
}
